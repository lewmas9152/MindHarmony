...
const AnimatedButton: React.FC<AnimatedButtonProps> = ({
  ...
  return (
    <button
      className={`${styles.rippleButton} ${styles.jumpButton}`}
      onClick={onClick}
    >
...
const Resources: React.FC = () => {
  ...
  const articles = [
    ...
    },
    {
      ...
      description: "Discover effective ways to manage daily stress...",
    },
    {
      image: articleImage3,
      title: "The Power of Positive Thinking",
      description:
        "Explore how positive thinking can improve your mental health...",
    },
    {
      image: articleImage4,
      title: "Building Healthy Relationships",
      description: "Tips for fostering strong, supportive relationships...",
    },
    {
      image: articleImage5,
      title: "Overcoming Depression",
      description: "Strategies for managing and overcoming depression...",
    },
    {
      image: articleImage6,
  ...
  const tools = [
    {
      background: toolBackground1,
      title: "Mindfulness and Meditation",
      description:
        "Practice being fully present and aware of your thoughts and feelings.",
    },
    {
      background: toolBackground2,
      title: "Cognitive-Behavioral Therapy (CBT)",
      description:
        "Learn techniques to manage thoughts, emotions, and behaviors.",
    },
    {
      background: toolBackground3,
      title: "Mindful Eating",
      description:
        "Develop a healthier relationship with food and eating habits.",
    },
    {
      background: toolBackground4,
      title: "Self-Care Routines",
      description:
        "Create and maintain healthy self-care practices for overall well-being.",
    },
    {
      background: toolBackground5,
      title: "Stress Reduction Techniques",
      description:
        "Explore various methods to reduce and manage stress in your life.",
    },
    {
      background: toolBackground6,
      title: "Sleep Hygiene",
      description:
      ...
      <div className="content-container">
        ...
        <div className="content">
          ...
          <section className="mood-tracker-anger-management">
            ...
            {moodTrackerVisible && (
              <div className="mood-tracker">
                <MoodTracker />
                <p>
                  Understanding your emotions is the first step towards better
                  mental health. Use this tool daily to track your mood and
                  identify patterns.
                </p>
              </div>
            )}
              ...
              {tools.map((tool, index) => (
                <div className="tool" key={index}>
                  <div
                    ...
                    style={{ backgroundImage: `url(${tool.background.src})` }}
                  ></div>
          ...
          <section className="journal">
            <h2>Daily Journal</h2>
            <p>
              Reflect on your thoughts and feelings by maintaining a daily
              journal.
            </p>
            <button
              className={styles.rippleButton}
          ...
          <section className="support-groups">
            ...
            <button className={styles.rippleButton} onClick={navigateToChat}>
              Join Chat
            </button>
          </section>
          <section className="crisis-helpline">
            ...
            <p>
              If you are in crisis, do not hesitate to reach out for immediate
              support.
            </p>
